...
function get_cookies(request, url, dev, trailing_slash) {
  ...
  if (dev) {
    const initial_decoded_cookies = parse$1(header, { decode: decodeURIComponent });
