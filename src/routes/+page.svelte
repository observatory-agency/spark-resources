...
<div class="bg-warmWhite">
	...
	<div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
		<div
			class="max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-24 lg:px-8"
		>
			<div>
				<a href="https://sparkstrategies.co/">
					<img src={fullLogo} alt="Spark Strategies logo" class="w-40" />
				</a>
				<div class="mt-16">
					<div>
						<div class="inline-flex sm:space-x-4">
							<span
								...
								>What's new</span
							>
							<span class="inline-flex items-center space-x-1 text-sm font-medium text-fadedBlack">
		...
		<div class="sm:mx-auto sm:max-w-3xl sm:px-6">
			<div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
				...
				<div
					class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12"
				>
					<img
	...
	<div class="relative mt-20">
		<div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-center lg:gap-24 lg:px-8">
			<div class="relative sm:py-16 lg:py-0">
				...
				>
					<div class="absolute inset-y-0 w-full right-1/2 rounded-r-3xl bg-neonGreen lg:right-72" />
				</div>
				<div
						...
						<div class="relative px-8">
							<blockquote class="mt-8">
								<div class="relative text-lg font-medium text-white md:flex-grow">
									...
									<p class="relative">
										Nicole is the best investment you will make into your studio business. We set up
										SOPs, rebranded our studio's foundation and changed our whole sales process. In
										4 months my investment in her program has already been returned and then some.
									</p>
								</div>
			...
			<div class="relative max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:px-0">
				...
				<div class="pt-12 sm:pt-16 lg:pt-20">
					...
					<div class="mt-6 space-y-6 text-fadedBlack">
						<p class="text-lg">
							Spark Strategies was built from a deep need for professionalization in the industry we
							love the most. We believe that every female entrepreneur deserves the knowledge and
							tools required to run a business that not only survives - but thrives! Inside this
							library, you'll find the very best of what we know about running a boutique studio
							business. The best part? It's on us.
						</p>
					</div>
				</div>
				...
				<!-- <div class="mt-10">
						...
						<div class="mt-10">
							<a
								href="https://sparkstrategies.co/#about"
								class="text-base font-medium text-sparkRaspberry"
