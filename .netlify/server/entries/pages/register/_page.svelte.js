...
<div class="flex flex-col justify-center min-h-full py-12 sm:px-6 lg:px-8"><div class="sm:mx-auto sm:w-full sm:max-w-md"><a href="/"><img${add_attribute("src", Logo, 0)} alt="Spark Strategies logo" class="w-16 mx-auto"></a>
		<h2 class="mt-6 text-3xl text-center text-fadedBlack">Create your account</h2>
		<p class="mt-2 text-center text-fadedBlack">Already a member?
			<a href="/login" class="font-medium text-fadedBlack hover:text-citrusOrange underline">Sign in</a></p></div>

	<div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md bg-neonGreen rounded-xl"><div class="px-4 py-8 shadow-lg sm:px-10 rounded-xl"><form class="space-y-6" action="?/register" method="POST"><div><label for="email" class="block font-medium text-fadedBlack">Email address</label>
				...
				<div><label for="password" class="block font-medium text-fadedBlack">Password</label>
				...
				<div><button type="submit" class="flex justify-center w-full px-4 py-2 font-medium text-white border border-transparent rounded-md shadow-sm bg-fadedBlack hover:bg-forestGreen focus:outline-none focus:ring-2 focus:ring-fadedBlack focus:ring-offset-2">Create account</button></div></form></div></div></div>`;
});
export {
  Page as default
};
